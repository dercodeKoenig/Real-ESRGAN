...
class RRDB_UNet_v7_t(nn.Module):

    def __init__(self, num_in_ch, num_out_ch, highway_channels_base=32, processing_channels_base=16, num_grow_ch_base=8,
                 encoder_blocks=4, decoder_blocks=6, ae_channel_multipliers = [1,2,4,8,16], body_rrdb_blocks=12, t_hidden_dim = 1024, memory_efficient_inference_device = None, inference = False, checkpoint = False):

        super(RRDB_UNet_v7_t, self).__init__()
