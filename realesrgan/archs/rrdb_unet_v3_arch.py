...
class NoiseInjectionLayer(nn.Module):
    def __init__(self, channels):
        ...
        """
        super().__init__()
        # Learnable scale parameter: 1 scale value per feature channel.
        # Shape is (1, C, 1, 1) to broadcast over Batch (B), Height (H), and Width (W).
        # Initialized to 0 so the network starts deterministic and learns to add noise.
    ...
    def forward(self, x):
        ...
        """
        # 1. Generate independent noise for every channel
